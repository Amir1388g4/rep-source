...
TELEGRAM_TOKEN = "8938090983:AAHw72JBNpQSWJcU5FcgGvvU8qNmPa12-Zw"
ADMIN_IDS: set[int] = {7468529723}
ADMIN_USERNAME = "@iD_ASTRO"
ADMIN_CARD_NUMBER = "6037697680852388"
PREMIUM_MONTHS = 1

REQUIRED_CHANNELS = ["https://t.me/ASTRO_DINET"]

FREE_LIMIT = 100
PREMIUM_LIMIT = 1000
PREMIUM_PRICE = "350,000 هزار تومان"
REPORT_DELAY = 3
...
def kb_main(lang: str, premium: bool) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text=t(lang, "web_app"), url="https://rep-source-production.up.railway.app", style=ButtonStyle.SUCCESS),
    ...
    if data == "subscription":
        ...
        if premium:
            ...
            web_app_kb = InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text="🌐 " + ("خرید از وب اپ" if lang == "fa" else "Buy via Web App"), url="https://rep-source-production.up.railway.app", style=ButtonStyle.SUCCESS)],
                [InlineKeyboardButton(text=t(lang, "back"), callback_data="back_menu", style=ButtonStyle.PRIMARY)],
            ])
            await callback.message.answer(
...
<a href="https://t.me/RedAstro_bot" target="_blank" class="qa-btn">
...
<div class="card-number">6037697680852388</div>
